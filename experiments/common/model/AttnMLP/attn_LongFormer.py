"""change from https://github.com/allenai/longformer/blob/master/longformer/longformer_encoder_decoder.py"""
...
if __name__ == "__main__":
    # Example usage
    attention = LongFormer(dim=64, heads=8, dim_head=8)
    x = torch.randn(128, 64, 64)  # Batch of 10 sequences of length 20 with dimension 128
    output = attention(x)
